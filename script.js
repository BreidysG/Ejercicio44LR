...
function displayBars(barNumber) {
    ...
    const separations = [100, 200, 300, 400, 500, 600, 700, 800]; // Distancia horizontal entre las barras
    const height = [100, 150, 200, 250, 300, 350, 400, 500]; // Altura de las barras
